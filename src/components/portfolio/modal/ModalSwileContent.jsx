      ...
      <figure>
        ...
        <Slider {...settings}>
          <div className="slide_item">
            <img src="img/projects/swile/swile.co.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/swile/swile.co1.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/swile/swile.co2.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/swile/swile.co3.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/swile/swile.co4.PNG" alt="slide 1" />
          </div>
        </Slider>
