      ...
      <figure>
        ...
        <Slider {...settings}>
          <div className="slide_item">
            <img src="img/projects/rimac/rimac.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/rimac/rimac1.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/rimac/rimac2.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/rimac/rimac3.PNG" alt="slide 1" />
          </div>
          <div className="slide_item">
            <img src="img/projects/rimac/rimac5.png" alt="slide 1" />
          </div>
        </Slider>
